...
```
    ...
    # A tibble: 39,644 × 61
     ...
     1 http://mas…     731      12     219   0.664    1.00   0.815       4       2       1       0
     2 http://mas…     731       9     255   0.605    1.00   0.792       3       1       1       0
     3 http://mas…     731       9     211   0.575    1.00   0.664       3       1       1       0
     4 http://mas…     731       9     531   0.504    1.00   0.666       9       0       1       0
     5 http://mas…     731      13    1072   0.416    1.00   0.541      19      19      20       0
     6 http://mas…     731      10     370   0.560    1.00   0.698       2       2       0       0
     7 http://mas…     731       8     960   0.418    1.00   0.550      21      20      20       0
     8 http://mas…     731      12     989   0.434    1.00   0.572      20      20      20       0
     9 http://mas…     731      11      97   0.670    1.00   0.837       2       0       0       0
    10 http://mas…     731      10     231   0.636    1.00   0.797       4       1       1       1
    # … with 39,634 more rows, 50 more variables: average_token_length <dbl>, num_keywords <dbl>,
...
```
    ...
    # A tibble: 2,099 × 53
       n_tokens_…¹ n_tok…² n_uni…³ n_non…⁴ n_non…⁵ num_h…⁶ num_s…⁷ num_i…⁸ num_v…⁹ avera…˟ num_k…˟
...
table(Lifestyle$data_channel_is_lifestyle)
```
...
summary(LifestyleTrain$weekday_is_monday)
```
...
summary(LifestyleTrain$weekday_is_tuesday)
```
...
summary(LifestyleTrain$weekday_is_wednesday)
```
...
summary(LifestyleTrain$weekday_is_thursday)
```
...
summary(LifestyleTrain$weekday_is_friday)
```
...
summary(LifestyleTrain$weekday_is_saturday)
```
...
summary(LifestyleTrain$weekday_is_sunday)
```
...
summary(LifestyleTrain$is_weekend)
```
...
table(LifestyleTrain$weekday_is_monday, LifestyleTrain$weekday_is_tuesday)
```
...
``` r
table(LifestyleTrain$weekday_is_monday, LifestyleTrain$weekday_is_wednesday)
```
...
``` r
table(LifestyleTrain$weekday_is_monday, LifestyleTrain$weekday_is_thursday)
```
...
``` r
table(LifestyleTrain$weekday_is_monday, LifestyleTrain$weekday_is_friday)
```
...
plot_data_weekday_weekend <- LifestyleTrain %>%
...
#ggplot(data=LifestyleTrain, aes(y=shares, x=weekday_is_monday)) + geom_point()
...
#fitting the model
fit_Lifestyle <- lm(shares ~ . , data = Lifestyle)
...
```
    ...
    Call:
    lm(formula = shares ~ ., data = Lifestyle)
...
``` r
ggplot(data=fit_Lifestyle, aes(y=shares, x=rate_positive_words)) + geom_point()
```
...
#shares_corr <- Lifestyle_corr[ ,"shares"]
...
corr_vars <- as.tibble ( Lifestyle_corr[ ,"shares"] ) %>%
             filter ( abs(value) >= 0.9 )

#dont need this anymore...
#corr_vars <- findCorrelation(x=Lifestyle_corr, cutoff = +/- 0.9, verbose = TRUE, names = TRUE)
...
```
     ...
     Min.   : 3.000   Min.   :   0.0   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000          
     1st Qu.: 8.000   1st Qu.: 315.0   1st Qu.:0.4626   1st Qu.:1.0000   1st Qu.:0.6292          
     Median :10.000   Median : 501.5   Median :0.5178   Median :1.0000   Median :0.6829          
     Mean   : 9.762   Mean   : 633.3   Mean   :0.5211   Mean   :0.9891   Mean   :0.6818          
     3rd Qu.:11.000   3rd Qu.: 801.5   3rd Qu.:0.5886   3rd Qu.:1.0000   3rd Qu.:0.7514          
     Max.   :17.000   Max.   :8474.0   Max.   :0.8248   Max.   :1.0000   Max.   :0.9697          
       num_hrefs      num_self_hrefs      num_imgs         num_videos     average_token_length
     Min.   :  0.00   Min.   : 0.000   Min.   :  0.000   Min.   : 0.000   Min.   :0.000       
     1st Qu.:  6.00   1st Qu.: 1.000   1st Qu.:  1.000   1st Qu.: 0.000   1st Qu.:4.449       
     Median : 10.00   Median : 2.000   Median :  1.000   Median : 0.000   Median :4.620       
     Mean   : 13.61   Mean   : 2.566   Mean   :  5.058   Mean   : 0.485   Mean   :4.584       
     3rd Qu.: 19.00   3rd Qu.: 3.000   3rd Qu.:  8.000   3rd Qu.: 0.000   3rd Qu.:4.791       
     Max.   :145.00   Max.   :27.000   Max.   :111.000   Max.   :50.000   Max.   :5.947       
      num_keywords      kw_min_min       kw_max_min      kw_avg_min        kw_min_max    
     Min.   : 3.000   Min.   : -1.00   Min.   :    0   Min.   :   -1.0   Min.   :     0  
     1st Qu.: 7.000   1st Qu.: -1.00   1st Qu.:  488   1st Qu.:  185.5   1st Qu.:     0  
     Median : 8.000   Median :  4.00   Median :  803   Median :  296.3   Median :     0  
     Mean   : 8.235   Mean   : 41.06   Mean   : 1580   Mean   :  408.7   Mean   :  7057  
     3rd Qu.:10.000   3rd Qu.:  4.00   3rd Qu.: 1300   3rd Qu.:  444.9   3rd Qu.:  6300  
     Max.   :10.000   Max.   :377.00   Max.   :80400   Max.   :13744.8   Max.   :208300  
       kw_max_max       kw_avg_max       kw_min_avg     kw_max_avg      kw_avg_avg   
     Min.   :     0   Min.   :     0   Min.   :   0   Min.   :    0   Min.   :    0  
     1st Qu.:690400   1st Qu.:118866   1st Qu.:   0   1st Qu.: 4061   1st Qu.: 2638  
     Median :843300   Median :182440   Median :   0   Median : 5034   Median : 3227  
     Mean   :705830   Mean   :183327   Mean   :1052   Mean   : 6583   Mean   : 3401  
     3rd Qu.:843300   3rd Qu.:248253   3rd Qu.:2264   3rd Qu.: 7303   3rd Qu.: 3953  
     Max.   :843300   Max.   :491771   Max.   :3594   Max.   :95422   Max.   :20378  
     self_reference_min_shares self_reference_max_shares self_reference_avg_sharess
     Min.   :     0.0          Min.   :     0            Min.   :     0.0          
     1st Qu.:   648.8          1st Qu.:  1000            1st Qu.:   996.8          
     Median :  1700.0          Median :  2800            Median :  2485.1          
     Mean   :  4440.8          Mean   :  8445            Mean   :  6136.0          
     3rd Qu.:  3600.0          3rd Qu.:  6800            3rd Qu.:  5400.4          
     Max.   :138700.0          Max.   :690400            Max.   :401450.0          
     weekday_is_monday weekday_is_tuesday weekday_is_wednesday weekday_is_thursday
     Min.   :0.0000    Min.   :0.000      Min.   :0.0000       Min.   :0.0000     
     1st Qu.:0.0000    1st Qu.:0.000      1st Qu.:0.0000       1st Qu.:0.0000     
     Median :0.0000    Median :0.000      Median :0.0000       Median :0.0000     
     Mean   :0.1508    Mean   :0.163      Mean   :0.1882       Mean   :0.1651     
     ...
     Min.   :0.0000    Min.   :0.0000      Min.   :0.0000    Min.   :0.0000   Min.   :0.01818  
     1st Qu.:0.0000    1st Qu.:0.0000      1st Qu.:0.0000    1st Qu.:0.0000   1st Qu.:0.02250  
     Median :0.0000    Median :0.0000      Median :0.0000    Median :0.0000   Median :0.02913  
     Mean   :0.1433    Mean   :0.0856      Mean   :0.1039    Mean   :0.1895   Mean   :0.17892  
     3rd Qu.:0.0000    3rd Qu.:0.0000      3rd Qu.:0.0000    3rd Qu.:0.0000   3rd Qu.:0.25060  
     Max.   :1.0000    Max.   :1.0000      Max.   :1.0000    Max.   :1.0000   Max.   :0.91980  
         LDA_01            LDA_02            LDA_03            LDA_04        global_subjectivity
     Min.   :0.01819   Min.   :0.01819   Min.   :0.01820   Min.   :0.02014   Min.   :0.0000     
     1st Qu.:0.02222   1st Qu.:0.02222   1st Qu.:0.02260   1st Qu.:0.32329   1st Qu.:0.4265     
     Median :0.02507   Median :0.02523   Median :0.02925   Median :0.56851   Median :0.4780     
     Mean   :0.06751   Mean   :0.07769   Mean   :0.14188   Mean   :0.53400   Mean   :0.4734     
     3rd Qu.:0.04001   3rd Qu.:0.06667   3rd Qu.:0.19724   3rd Qu.:0.79956   3rd Qu.:0.5273     
     Max.   :0.68825   Max.   :0.67623   Max.   :0.91892   Max.   :0.92707   Max.   :0.7778     
     global_sentiment_polarity global_rate_positive_words global_rate_negative_words
     Min.   :-0.30000          Min.   :0.00000            Min.   :0.00000           
     1st Qu.: 0.09929          1st Qu.:0.03493            1st Qu.:0.01025           
     Median : 0.15023          Median :0.04424            Median :0.01521           
     Mean   : 0.15143          Mean   :0.04457            Mean   :0.01632           
     3rd Qu.: 0.20511          3rd Qu.:0.05378            3rd Qu.:0.02094           
     Max.   : 0.51389          Max.   :0.10791            Max.   :0.06180           
     rate_positive_words rate_negative_words avg_positive_polarity min_positive_polarity
     Min.   :0.0000      Min.   :0.0000      Min.   :0.0000        Min.   :0.00000      
     1st Qu.:0.6667      1st Qu.:0.1852      1st Qu.:0.3358        1st Qu.:0.05000      
     Median :0.7399      Median :0.2560      Median :0.3836        Median :0.10000      
     Mean   :0.7235      Mean   :0.2657      Mean   :0.3824        Mean   :0.09207      
     3rd Qu.:0.8125      3rd Qu.:0.3333      3rd Qu.:0.4335        3rd Qu.:0.10000      
     Max.   :1.0000      Max.   :1.0000      Max.   :0.7553        Max.   :0.50000      
     max_positive_polarity avg_negative_polarity min_negative_polarity max_negative_polarity
     Min.   :0.0000        Min.   :-1.0000       Min.   :-1.0000       Min.   :-1.0000      
     1st Qu.:0.7000        1st Qu.:-0.3250       1st Qu.:-0.7143       1st Qu.:-0.1250      
     Median :0.9000        Median :-0.2625       Median :-0.5000       Median :-0.1000      
     Mean   :0.8297        Mean   :-0.2671       Mean   :-0.5633       Mean   :-0.1046      
     3rd Qu.:1.0000        3rd Qu.:-0.2039       3rd Qu.:-0.4000       3rd Qu.:-0.0500      
...
#predicting on the LifestyleTest data with linear regression model 1
...
#predictions based on linear model 2 for the LifestyleTest data
...
r_f <- train(shares ~ n_tokens_title +  n_tokens_content + num_imgs + num_videos + 
                      is_weekend , data = LifestyleTrain, method = "rf",
