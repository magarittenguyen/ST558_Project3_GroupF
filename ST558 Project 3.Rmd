...
#same seed will be utilized below in the Parallel Computing section of HW6
set.seed(123)
```
...
# Topic
What are you actually doing? You’ll read in and analyze an online news popularity data set. You’ll subset
the data by data_channel_is_* (one of six groups). Then you’ll summarize the data and try to predict the number of shares using predictive models.
...
#e.g. combo object and the fina proportions tibble
