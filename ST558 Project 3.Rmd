...
The final two models (second linear and boosting) will use the following as the independent variables
...
In our model we use all combination of the tuning parameters
