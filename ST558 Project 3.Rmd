...
As stated in the the first linear regression model we will model the number of shares by "weekday_is_thursday" (Was the article published on a Thursday?), "weekday_is_friday" (Was the article published on a Friday?) and "is_weekend" (Was the article published on the weekend?).
